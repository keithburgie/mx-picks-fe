...
export default function Leaderboard({ loggedIn }) {
    ...
    const names = [
        "Keith", "Brandon", "Paul", "Travis", "Brendan", "Ana", "Tyler", "Elliot", "Elijah", "Jedidiah", "Matt", "Ellen"
    ]
            ...
            return (
                ...
                a.points < b.points
                    ? 1 : a.points === b.points
                        ...
                        ? a.correctPicks < b.correctPicks ? 1 : -1
                        : -1
            )
        })
        setUsers(users)
            ...
            <Container fluid>
                <Row className="align-items-center">
                    ...
                    <Col className="text-right">
                        <Form.Group>
                            <Button variant="info" size="lg" type="button">Join League</Button>
                            {loggedIn && <Button variant="danger" size="lg" type="button">Create League</Button>}
